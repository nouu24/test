import { fetchHandler } from "@/app/api/handlers/fetch";
...
export const api = {
    ...
    users: {
        ...
        update: (id: string, userData: Partial<IUser>) => fetchHandler(`${API_BASE_URL}/user/${id}`, {
            method: "PUT",
            body: JSON.stringify(userData),
        }),
    ...
    accounts: {
        ...
        update: (id: string, accountData: Partial<IAccount>) => fetchHandler(`${API_BASE_URL}/user/${id}`, {
            method: "PUT",
            body: JSON.stringify(accountData),
        }),
